=== Plugin Name ===
Contributors: Gagan Goraya
Donate link: http://gagangoraya.com/
Tags: CSS class, widget
...
This plugin lets you specify CSS class(s) for widgets to apply your own CSS definitions to specific 
